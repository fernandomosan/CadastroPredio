...
namespace GerendiadorCondominos.DAL.Repositorios
{
    public class UsuarioRepositorio : RepositorioGenerico<Usuario>, IUsuarioRepositorio
    {
        ...
        public async Task<bool> VarificarSeUsuarioEstaEmFuncao(Usuario usuario, string funcao)
        {
            try
            {
        ...
        public async Task<Usuario> PegarUsuarioPoloNome(ClaimsPrincipal usuario)
        {
            try
            {
